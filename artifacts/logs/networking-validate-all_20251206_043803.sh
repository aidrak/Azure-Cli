cat > /tmp/networking-11-validate-all-wrapper.ps1 << 'PSWRAPPER'
...
PSWRAPPER
pwsh -NoProfile -NonInteractive -File /tmp/networking-11-validate-all-wrapper.ps1
rm -f /tmp/networking-11-validate-all-wrapper.ps1
